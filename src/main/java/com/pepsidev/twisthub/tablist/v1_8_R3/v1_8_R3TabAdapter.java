package com.pepsidev.twisthub.tablist.v1_8_R3;

import com.mojang.authlib.GameProfile;
import com.mojang.authlib.properties.Property;
import com.pepsidev.twisthub.Hub;
import com.pepsidev.twisthub.tablist.shared.TabAdapter;
import com.pepsidev.twisthub.tablist.shared.skin.SkinType;
import io.netty.channel.ChannelDuplexHandler;
import io.netty.channel.ChannelHandlerContext;
import io.netty.channel.ChannelPipeline;
import io.netty.channel.ChannelPromise;
import com.pepsidev.twisthub.tablist.shared.client.ClientVersionUtil;
...
public class v1_8_R3TabAdapter extends TabAdapter {
    ...
    public TabAdapter hideRealPlayers(Player player) {
        for (Player target : Hub.getInstance().getOnlinePlayers()) {
